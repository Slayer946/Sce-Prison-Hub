...
do
	...
	CmdButton.BackgroundColor3 = Color3.fromRGB(135, 206, 250)
...
do
	...
	tempb.BackgroundColor3 = Color3.fromRGB(135, 206, 250)
...
CommandBar.BackgroundColor3 = Color3.fromRGB(135, 206, 250)
...
CommandBar.Text = ""
CommandBar.TextColor3 = Color3.fromRGB(255, 0, 0)
...
if writefile and makefolder and readfile and isfile then
	if isfile("Sce Prison Hub") == false or isfile("Sce_Prison_Hub/Invite.json") == false then
		...
		if isfile("Sce_Prison_Hub/SavedAdmins.json") == false then
			writefile("Sce_Prison_Hub/SavedAdmins.json",game:GetService("HttpService"):JSONEncode({}))
		else
...
task.spawn(function()
	if writefile and makefolder and readfile and isfile then
		if game:GetService("HttpService"):JSONDecode(readfile("Sce_Prison_Hub/Invite.json")).Invite_To_Server then
